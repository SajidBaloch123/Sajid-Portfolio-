  ...
  <section id="home" class="hero">
    ...
    <div class="container hero-grid">
      <div class="hero-text fade-in">
        ...
        <h1>Hi, I'm <span class="gradient">Engr. Sajid Ali</span></h1>
        <h2 class="hero-role">
          <span>{{ currentRole }}</span><span class="cursor">|</span>
        </h2>
        <p class="hero-desc">
          Computer Systems Engineer passionate about building intelligent systems using
          IoT, AI/ML, and Embedded technologies. PEC Registered Engineer focused on
        ...
        <div class="hero-actions">
          ...
          <a href="/Sajid-Ali-CV.pdf" download class="btn btn-outline">
        ...
        <div class="hero-socials">
          ...
          <a href="mailto:sajidbbaloch69@gmail.com" aria-label="Email">
      ...
      <div class="hero-visual fade-in">
        <div class="profile-ring">
          <div class="profile-img">
            <img src="/profile.png" alt="Engr. Sajid Ali" />
          </div>
...
.ring-2 { inset: -20px; animation: spin 30s linear infinite reverse; border-color: rgba(16, 185, 129, 0.15); }
